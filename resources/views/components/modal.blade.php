    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="width: 526px !important;">
            <div class="modal-header">
                <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      <div id="success-flag"  role="alert"></div>
                    <div id="success-flag-error" class="ml-3" role="alert"></div>
            ...
            <div class="modal-body">
                <form class="needs-validation" action="#" method="POST" novalidate>
                @csrf
                 <input type="hidden" id="flag_epic_id">
                <input type="hidden" id="flag_ini_epic_id">
                <input type="hidden" id="flag_epic_obj">
                <input type="hidden" id="flag_epic_key">
                    <div class="row">
                         ...
                         <div class="col-md-12 col-lg-12 col-xl-12">
                            <div class="form-group mb-0">
                                ...
                                <label for="small-description">Title</label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <button class="btn btn-primary btn-lg btn-theme btn-block ripple mt-3" onclick="FlgEpic();"  type="button">Add Flag</button>
                        </div>
                    </div>
                </form>
            </div>
