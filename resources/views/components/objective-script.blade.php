...
// });
	...
	var fieldHTML = '<div class="d-flex w-50 mb-3"><input type="text" placeholder="Target Value" onkeypress="return onlyNumberKey(event)"  id="customFile" class="form-control target_value"/><a href="javascript:void(0);"  class="remove_button btn btn-light-danger"><i class="fa fa-minus"></i></a></div>';
