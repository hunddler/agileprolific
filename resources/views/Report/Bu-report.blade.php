                                                                                ...
                                                                                <div class="card report-parent-card mb-3">
                                                                                    <div class="card-body">
                                                                                        <div class="d-flex flex-row justify-content-between align-items-center">
                                                                                            ...
                                                                                            <div class="d-flex flex-row">
                                                                                                <div class="mr-2"> @foreach($key as $k) <a  href="{{url('dashboard/organization/report-2/'.$k->id.'/'.$r->id)}}"  @endforeach  class="btn btn-default">See Report</a></div>
                                                                                                <div><button class="btn btn-default">Download</button></div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="card-body">
                                                                                        <div class="d-flex flex-row justify-content-between align-items-center">
                                                                                            ...
                                                                                            <div class="d-flex flex-column content-area">
                                                                                                ...
                                                                                                <div>
                                                                                                    <p>Tracks Objectives and Key Results progress against</p>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="d-flex flex-row">
                                                                                                <div class="mr-2"><button class="btn btn-default">See Report</button></div>
                                                                                                <div><button class="btn btn-default">Download</button></div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
